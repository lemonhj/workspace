...
<html>
	...
	<body  class="easyui-layout" >
        <div data-options="region:'north'" style="height:60px;padding:10px">
	        <div style="padding:5px 0;">
		        ...
		        <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-application_delete'" style="width:80px;" onclick="delRights()">删除</a>
	    	</div>
        </div>
        <div data-options="region:'center',title:'权限管理',iconCls:'icon-building_link',resizable:true,modal:true,closed:false">
             <div id="rightsList" style="height:353px;"></div>
        </div>
        <div id="rightwin" style="width:516px;height:250px;"></div>
	</body>
	<!-- js代码段 -->
	<script type="text/javascript">
		...
		//设置grid的高度
		document.getElementById("rightsList").style.height=height+"px";
