...
public class ToolKit {
	...
	private static void loadProperties() {
		...
		try {
			...
			InputStream is = ToolKit.class.getClassLoader()
	 ...
	 *            用户刷新标志
	 */
	public static void saveTokenToRequest(HttpServletRequest request,
			String tokenValue, boolean isRefresh) {
