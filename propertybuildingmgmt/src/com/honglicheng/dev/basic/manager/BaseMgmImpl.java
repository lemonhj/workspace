...
import com.honglicheng.dev.basic.datastructure.ColumnTreeNode;
import com.honglicheng.dev.basic.datastructure.TreeNode;
import com.honglicheng.dev.basic.env.BusinessException;
import com.honglicheng.dev.basic.env.Constant;
import com.honglicheng.dev.basic.util.JSONUtil;
import com.honglicheng.dev.basic.util.JdbcUtil;
import com.honglicheng.dev.basic.util.MD5Util;
...
public class BaseMgmImpl implements BaseMgmFacade {	
	...
	public void initHibernateConfiguration() {
		LocalSessionFactoryBean  LocalSessionFactoryBean = (LocalSessionFactoryBean)this.wac.getBean("&sessionFactory");
